...
const ReactStackModal = (props: Props) => {
    return (
        <Modal onClose={props.onClose}>
            <List listStyleType="disc">
                <ListItemFormControl
                    ...
                    labelBold
                    contents={[
                        'React로 개발할 수 있는 초기 환경들을 구성할 수 있어요',
                        'React에 TypeScript를 사용하여 개발하는 것을 선호해요',
...
export default ReactStackModal;
